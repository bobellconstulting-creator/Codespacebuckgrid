...
export default function BuckGridProPage() {
  ...
  return (
    <div style={{ height: '100dvh', width: '100vw', background: '#000', overflow: 'hidden', position: 'fixed' }}>
      ...
      <TonyChat ref={chatRef} getCaptureTarget={() => mapRef.current?.getCaptureElement() ?? null} situation={{ propertyAcres, activeTool: activeTool.id, brushSize, borderLocked: propertyAcres > 0 }} />
